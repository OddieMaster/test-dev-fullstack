                ...
                <>
                    ...
                    <DialogActions>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText>
                                    This action will delete all information from
                                    this patient!
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                    ...
                    <DialogContent>
                        ...
                        >
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="number"
                                defaultValue={data[ControlIndex].cellphone}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 8,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                defaultValue={data[ControlIndex].cpf}
                                type="text"
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].rg}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 8,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="email"
                                defaultValue={data[ControlIndex].email}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 5,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="date"
                                defaultValue={data[ControlIndex].bdate}
                                InputLabelProps={{
                                    shrink: true,
                                }}
                                variant="outlined"
                            ...
                            <TextField
                                ...
                                label="Street"
                                margin="normal"
                                defaultValue={data[ControlIndex].street}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 5,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].addressDetails}
                                variant="outlined"
                            />
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].city}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 3,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].state}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 1,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].requestedBy}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 3,
                            ...
                            <TextField
                                ...
                                margin="normal"
                                type="text"
                                defaultValue={data[ControlIndex].agreement}
                                variant="outlined"
                                inputRef={register({
                                    required: true,
                                    minLength: 3,
                            ...
                            <FormControl
                                ...
                                margin="normal"
                                defaultValue={data[ControlIndex].doctor}
                            >
                                ...
                                <Controller
                                    as={
                                        <Select name="doctor" label="Doctor">
                                            ...
                                            <MenuItem value={"Jéssica"}>
                                                Jéssica
                                            </MenuItem>
                                            <MenuItem value={"Vitor"}>
                                                Vitor
                                            </MenuItem>
                                        </Select>
                                    }
                            ...
                            >
                                ...
                                <Controller
                                    ...
                                    name="exam"
                                    control={control}
                                    defaultValue={data[ControlIndex].exam}
                                    value={Exam}
